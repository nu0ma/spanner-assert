Add E2E tests for this library using Taskfiles.

The YAML below outlines the desired workflow.
It provisions a Spanner Emulator, executes assertions, and tears the environment down.
